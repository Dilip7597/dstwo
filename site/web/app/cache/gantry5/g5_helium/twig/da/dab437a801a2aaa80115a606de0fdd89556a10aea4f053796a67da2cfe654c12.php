...
class __TwigTemplate_e82cfd85f4bfd083839dac8d1eee7bd691f37e062294bc738edc09e4e52e6e78 extends Twig_Template
{
    ...
    public function block_meta($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute(($context["gantry"] ?? null), "config", array()), "get", array(0 => (("content." . ($context["scope"] ?? null)) . ".meta-comments.enabled"), 1 => "1"), "method")) {
            ...
            if (($this->getAttribute(($context["post"] ?? null), "comment_count", array()) == "0")) {
                // line 55
                echo "                    ";
                $context["comment_count"] = call_user_func_array($this->env->getFunction('__')->getCallable(), array("No comments", "g5_helium"));
                // line 56
                echo "                ";
            } elseif (($this->getAttribute(($context["post"] ?? null), "comment_count", array()) == "1")) {
                // line 57
                echo "                    ";
                $context["comment_count"] = (($this->getAttribute(($context["post"] ?? null), "comment_count", array()) . " ") . call_user_func_array($this->env->getFunction('__')->getCallable(), array("Comment", "g5_helium")));
                // line 58
                echo "                ";
            } else {
                // line 59
                echo "                    ";
                $context["comment_count"] = (($this->getAttribute(($context["post"] ?? null), "comment_count", array()) . " ") . call_user_func_array($this->env->getFunction('__')->getCallable(), array("Comments", "g5_helium")));
                // line 60
                echo "                ";
            }
            // line 61
...
", "partials/meta.html.twig", "/srv/www/www.dsourc.com/current/web/app/themes/g5_helium/views/partials/meta.html.twig");
    }
}
